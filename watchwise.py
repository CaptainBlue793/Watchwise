...
def poster(movie_ID):
    response = requests.get('https://api.themoviedb.org/3/movie/{}?api_key=e49ee15fc4cf141aff585cab7b7998d9'.format(movie_ID))
    data = response.json()
...
add_bg_from_local('desktop-1920x1080 (1).jpg')
...
st.markdown('<h2 style="color: #F5FEFD; text-align: center;">Movies Recommendation System</h2>', unsafe_allow_html=True)
st.markdown('<h3 style="color: #F5FEFD; text-align: center;">Discover movies similar to your favourite '
            'blockbuster</h3>', unsafe_allow_html=True)
